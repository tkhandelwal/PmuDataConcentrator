...
- Create Angular project with ng: `ng new pmudataconcentrator.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`pmudataconcentrator.client.esproj`).
